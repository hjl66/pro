...
<head>
    ...
    <title>爱钱帮成立消费金融事业部，切入租房、装修、教育等领域--爱钱帮</title>
...
//			});
    ...
    <div class="m2-newsDisbread-con">
        <div class="m2-newsDisbread">
            <p>
                <span class="m2-newsDisbread-fir"><a href="index.html">首页&nbsp;&gt;</a></span>
                <span class="m2-newsDisbread-fir"><a href="aiqianbang_touzilicaigongsi_dashiji-list-1">大事记&nbsp;&gt;</a></span>
                <span class="m2-newsDisbread-cur">爱钱帮成立消费金融事业部，切入租房、装修、教育等领域</span>
            </p>
        </div>
        <a href="/register-ad" target="_blank"><div class="m2-newsDis-banner">
        </div></a>
        <div class="m2-newsDismain-con">
            <div class="m2-newsDismain">
                <div class="m2-newsDismain-head">
                    <img src="" alt="" class="m2-newsDismain-headLogo">
                    <h1>爱钱帮成立消费金融事业部，切入租房、装修、教育等领域</h1>
                    <div class="m2-newsDismain-headBread">
                        <div class="m2-newsDismain-headBread-box">
                            <span class="m2-newsDismain-headTit">发布时间：</span><span class="m2-newsDismain-headDet">2016-04-22</span>
                            <!--							<span class="m2-newsDismain-headTit">点击次数：</span><span class="m2-newsDismain-headDet">0</span>-->
                            <!---->
                        </div>
                    </div>
                </div>
                <div class="m2-newsDismain-adv">
                    <img src="statics/home2/images/article/banner/m2-newListadv01.jpg" alt="" id='subbanner'  onclick="window.open('/market-aprilcelebration-main')" style="cursor: pointer">
                </div>
                <div class="m2-newsDismain-psg" style='padding-left: 60px;padding-right: 60px;'>
                    <!-- 					<p class="m2-newsDismain-psgNor"></p> -->
                    <p style="text-indent:0"><span style="font-family:宋体">爱钱帮消费金融事业部正式成立。爱钱帮与湖南易安家签署入股协议书及战略合作协议。爱钱帮切入租房、教育、装修和医疗健康等领域，与多家合作伙伴签署战略合作协议，试水全新的消费分期产品。</span></p><p><br></p>					<p class="m2-newsDismain-psgRig"></p>
                </div>
            </div>
            <div class="m2-newsDislist">
                <h3>最新发布</h3>
                <ul class="m2-newsDislist-ul">
                    <li>
                        <a class="m2-newsDislist-itemTit" href="/aiqianbang_touzilicaigongsi_dashiji-15780.html">
                            <b class="m2-newsDisnum-red">						1</b><span>爱钱帮成立消费金融事业部，切入租房、装修、教育等领域</span></a>
                        <span class="m2-newsDislist-itemTime">2016年04月22日</span>
                    </li><li>
                    <a class="m2-newsDislist-itemTit" href="/aiqianbang_touzilicaigongsi_dashiji-15779.html">
                        <b class="m2-newsDisnum-red">						2</b><span>爱钱帮召开客户交流体验会</span></a>
                    <span class="m2-newsDislist-itemTime">2016年04月22日</span>
                </li><li>
                    <a class="m2-newsDislist-itemTit" href="/aiqianbang_touzilicaigongsi_dashiji-15778.html">
                        <b class="m2-newsDisnum-red">						3</b><span>爱钱帮携手江西银行推出“闪垫侠”，进军消费金融领域</span></a>
                    <span class="m2-newsDislist-itemTime">2016年04月22日</span>
                </li><li>
                    <a class="m2-newsDislist-itemTit" href="/aiqianbang_touzilicaigongsi_dashiji-15777.html">
                        <b class="m2-newsDisnum-grey">						4</b><span>爱钱帮建立车贷风控模型，资产安全再升级</span></a>
                    <span class="m2-newsDislist-itemTime">2016年04月22日</span>
                </li><li>
                    <a class="m2-newsDislist-itemTit" href="/aiqianbang_touzilicaigongsi_dashiji-15776.html">
                        <b class="m2-newsDisnum-grey">						5</b><span>爱钱帮单月交易额破亿</span></a>
                    <span class="m2-newsDislist-itemTime">2016年04月22日</span>
                </li><li>
                    <a class="m2-newsDislist-itemTit" href="/aiqianbang_touzilicaigongsi_dashiji-15775.html">
                        <b class="m2-newsDisnum-grey">						6</b><span>爱钱帮牵手徽商银行，首推“资金存管+余额理财”新模式</span></a>
                    <span class="m2-newsDislist-itemTime">2016年04月22日</span>
                </li><li>
                    <a class="m2-newsDislist-itemTit" href="/aiqianbang_touzilicaigongsi_dashiji-15774.html">
                        <b class="m2-newsDisnum-grey">						7</b><span>爱钱帮推动数据化风险管理</span></a>
                    <span class="m2-newsDislist-itemTime">2016年04月22日</span>
                </li><li>
                    <a class="m2-newsDislist-itemTit" href="/aiqianbang_touzilicaigongsi_dashiji-15773.html">
                        <b class="m2-newsDisnum-grey">						8</b><span>爱钱帮和深圳鹏元征信牵手合作</span></a>
                    <span class="m2-newsDislist-itemTime">2016年04月22日</span>
                </li><li>
                    <a class="m2-newsDislist-itemTit" href="/aiqianbang_touzilicaigongsi_dashiji-14745.html">
                        <b class="m2-newsDisnum-grey">						9</b><span>爱钱帮出席北京市网贷行业大会</span></a>
                    <span class="m2-newsDislist-itemTime">2015年01月12日</span>
                </li>				</ul>
            </div>
    ...
    <script>
        $('.m2-newsDismain-psg span').each(function(){
            $(this).css({'font-size':'16px','font-family':'微软雅黑','line-height': '30px'});
        });
        $('.m2-newsDismain-psg p').each(function(){
            $(this).css({'font-size':'16px','font-family':'微软雅黑'});
        });
        $('#subbanner').error(function (){
            var index = 1+Math.floor(Math.random()*4);
            this.src="statics/home2/images/article/banner/m2-newListadv0"+index+".jpg"
        });
    </script>
    ...
    <script type="text/javascript">
        ...
        var GV = {
            ...
            TOKEN: "f86fb5ee368be8f75463b12ec8e2ed5b_4278567bfe54d213fb2b3a8f6ff58a4f",
            THIS_URL: "Aboutus-",
